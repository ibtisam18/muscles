// src/components/UpperLimbFlashCardsApp.jsx
import React, { useState } from "react";
import { regions } from "../data/upperlimb.js";
import "./MuscleFlashCardsApp.css";

function UpperLimbFlashCardsApp() {
  ...
  return (
    <div className="app-root">
      <h1 className="title">Upper Limb Muscles</h1>

      {/* if you ever add more regions in this file, this will handle them */}
      ...
      >
        <div className="flip-card-inner">
          ...
          <div className="flip-card-face flip-card-front">
            {currentMuscle ? (
              <>
                ...
                <h2 className="muscle-name centered">
                  {currentMuscle.name}
                </h2>
              </>
            ) : (
          ...
          <div className="flip-card-face flip-card-back">
            {currentMuscle ? (
              <>
                <h2 className="muscle-name">{currentMuscle.name}</h2>
...
export default UpperLimbFlashCardsApp;
