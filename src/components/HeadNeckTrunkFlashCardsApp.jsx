// src/components/HeadNeckTrunkFlashCardsApp.jsx
import React, { useState } from "react";
import { regions } from "../data/headnecktrunk.js";
import "./MuscleFlashCardsApp.css";

function HeadNeckTrunkFlashCardsApp() {
  ...
  return (
    <div className="app-root">
      <h1 className="title">Head, Neck & Trunk Muscles</h1>

      {/* Tabs for Head / Neck / Trunk */}
...
export default HeadNeckTrunkFlashCardsApp;
